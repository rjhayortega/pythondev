			...
			$body1  = '<table width="600" cellspacing="0" cellpadding="0" style="border:1px solid #CCC; padding:15px; font-size:14px; line-height:25px; font-family:open sans">
				...
				$body3  = '<table width="600" cellspacing="0" cellpadding="0" style="border:1px solid #CCC; padding:15px; font-size:14px; line-height:25px; font-family:open sans">
				  <tbody>
					...
					$body4  = '<table width="600" cellspacing="0" cellpadding="0" style="border:1px solid #CCC; padding:15px; font-size:14px; line-height:25px; font-family:open sans">
				  <tbody>
					<tr style="background:#666;">
					  <td style="padding:15px;">          
					  <a href="https://knackmap.com/"><img width="150" src="https://knackmap.com/img/logo_knackmap.png"></a></td>
					...
					<tr>
					  <td colspan="2"><img src="http://app.knackmap.com/pdev/0185722b563d116680ee8b42f365f4d8.png"></td>
					</tr>
					<tr>
					  <td colspan="2"><p style="color:#fff; text-align:center; font-size:22px; color:#333;"><strong>Welcome to our Knackmap Family!</strong></p>
						<p>Hello'.$name.',</p>
						<p>Thanks for subscribing to our .</p>
						<p>, you can now get started on our platform!<</p>						
						<br>              						
						<p style="font-size:20px;padding:15px 0;">
								Please use below credentials to get into our platform:</br></br>

<b>Username:</b> ['.$email.']</br>
<b>Password:</b> ['.$password.']
</br></br>
Our friendly team are only a live chat or email away, so dont hesitate to get in touch!

Our Customer Service lead Dolly will be in touch with you at some point soon to check up and make sure that you are going well on our platform 🙂

Thanks,


						</p>
						<p style="border-radius: 50px; overflow: hidden; width: 100px; height: 100px; padding: 0px; border: 1px solid rgb(204, 204, 204);"><img src="https://knackmap.com/wp-content/uploads/2018/02/josh.jpg" style="width: 100%; height: auto; po sition: relative; top: 8px;"></p>
						<p class="name" style="font-size: 24px; color: rgb(16, 171, 75); font-weight: bold; line-height: 25px; margin-top: 0px !important; margin-bottom: 0px !important;">Joshua White</p>
						<p style="color: rgb(0, 0, 0);">Founder and CEO, Knackmap</p></td>
					</tr>
					<tr style="background:#434854;color:#fff;">
				...
				$body5 = '<img src=></img><b></br></br>Welcome to our Knackmap Family!</b></br></br>Hello [Ronald],</br></br>Thanks for subscribing to our [package name] plan, you can now get started on our platform!</br></br>';
